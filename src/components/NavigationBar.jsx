                            ...
                            <div className="p-4">
                              {solutions.map((page) => (
                                <div key={page.name} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-50 dark:hover:bg-slate-700">
                                  ...
                                  <div>
                                    <a href={page.href} className="font-semibold text-slate-900 dark:text-slate-200">
                                      {page.name}
                                      <span className="absolute inset-0" />
                                    </a>
                                    <p className="mt-1 text-slate-700 dark:text-slate-400">{page.description}</p>
                                  </div>
                                </div>
                              ))}
                            </div>
                            <div className="grid grid-cols-1 divide-x divide-gray-900/5 dark:divide-slate-800 bg-gray-50 dark:bg-slate-700">
                              <a
                                key={item.name}
                                href={item.href}
                                className="flex items-center justify-center gap-x-2.5 p-3 font-semibold text-slate-900 dark:text-slate-200 hover:bg-gray-100 dark:hover:bg-slate-600"
                              >
                                View More
                              </a>
                            </div>
