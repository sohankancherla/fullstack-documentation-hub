      ...
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className="bg-opacity-100 pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5">
              <div className="p-4">
